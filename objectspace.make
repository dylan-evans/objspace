...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/objectspace
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/objectspace
  DEFINES   += -DDEBUG
  INCLUDES  += -Isrc
...
ifeq ($(config),production)
  OBJDIR     = obj/Production/objectspace
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/objectspace
  DEFINES   += 
  INCLUDES  += -Isrc
